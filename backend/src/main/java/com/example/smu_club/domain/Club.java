...
@Table(name = "club", indexes = {
        @Index(name = "idx_club_priority_name", columnList = "recruit_priority, name"),
        @Index(name = "idx_club_recruiting_closure", columnList = "recruiting_status, recruitment_end_at")
})
public class Club {
    @Id
